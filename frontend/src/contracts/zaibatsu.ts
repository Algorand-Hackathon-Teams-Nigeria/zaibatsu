...
export class ZaibatsuClient {
  ...
  public hello(args: MethodArgs<'hello(string)string'>, params: AppClientCallCoreParams & CoreAppCallArgs = {}) {
    return this.call(ZaibatsuCallFactory.hello(args, params))
  }
...
export type ZaibatsuComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  hello(args: MethodArgs<'hello(string)string'>, params?: AppClientCallCoreParams & CoreAppCallArgs): ZaibatsuComposer<[...TReturns, MethodReturn<'hello(string)string'>]>
