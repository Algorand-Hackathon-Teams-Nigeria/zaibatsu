        ...
        <div className="flex items-center flex-row ">
          ...
          >
            <div className="relative" onClick={toggleDarkMode}>
              <div className={`dark:invisible visible absolute top-0`}>
                {returnIcon("sun")}
              </div>
              <div className={`dark:visible invisible absolute top-0 `}>
                {returnIcon("moon")}
              </div>
            </div>
          ...
          >
            {navOpen ? (
              <IoClose className="text-white" size={26} />
            ) : (
              <IoMenu className="text-white" size={26} />
            )}
          </button>
        </div>
      </div>
